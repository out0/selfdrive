...
class SearchFrameCPU : public CPUframe<float3>
{
private:
...
public:
    SearchFrameCPU(int width, int height, std::pair<int, int> lowerBound, std::pair<int, int> upperBound, int numCPUThreadHandlers = 12);
    ~SearchFrameCPU();
