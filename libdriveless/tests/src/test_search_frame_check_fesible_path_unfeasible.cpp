...
TEST(TestSearchFrameCheckFeasiblePath, CheckPath_Unfeasible_PreProcessNoVectorized_CPU)
{
    SearchFrame f1(100, 100, {-1, -1}, {-1, -1});
...
TEST(TestSearchFrameCheckFeasiblePath, CheckPath_Unfeasible_PreProcessWithVectorized_CPU)
{
    SearchFrame f1(100, 100, {-1, -1}, {-1, -1});
...
TEST(TestSearchFrameCheckFeasiblePath, CheckPath_Unfeasible_NoPreProcess_GPU)
{
...
TEST(TestSearchFrameCheckFeasiblePath, CheckPath_Unfeasible_PreProcessNoVectorized_GPU)
{
    SearchFrame f1(100, 100, {5, 5}, {15, 15});
...
TEST(TestSearchFrameCheckFeasiblePath, CheckPath_Unfeasible_PreProcessWithVectorized_GPU)
{
    SearchFrame f1(100, 100, {5, 5}, {15, 15});
