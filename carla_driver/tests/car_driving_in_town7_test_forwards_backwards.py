...
def sensor_show(sim: CarlaSimulation, ego_vehicle: CarlaEgoVehicle):
...
def main():
    ...
    ego_vehicle.set_carla_autopilot(False)
    ...
    while True:
        ego_vehicle.set_power(0.7)
        time.sleep(5)
        ego_vehicle.set_brake(1.0)
        time.sleep(5)
        ego_vehicle.set_power(-0.7)
        time.sleep(5)
        ego_vehicle.set_brake(1.0)
