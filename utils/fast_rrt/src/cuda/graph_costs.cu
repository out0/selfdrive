...
__device__ __host__ float computeCost(float3 *frame, int3 *graph, float4 *graphData, double *physicalParams, float *classCosts, int width, float goalHeading_rad, long nodePos, double distToParent) {
