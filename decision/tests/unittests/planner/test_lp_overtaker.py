...
class TestLPOvertaker(unittest.TestCase):
    ...
    def test_free_area(self):
        ...
        conv = CoordinateConverter(origin=TestLPOvertaker.ORIGIN, width=100, height=100, perceptionHeightSize_m=1, perceptionWidthSize_m=1)
        planner = Overtaker(max_exec_time_ms=TestLPOvertaker.TIMEOUT_MS)
