...
class TestLPHybridA(unittest.TestCase):
    ...
    def test_bev_1(self):
        ...
        conv = CoordinateConverter(origin=TestLPHybridA.ORIGIN, width=PhysicalParameters.OG_WIDTH, height=PhysicalParameters.OG_HEIGHT, perceptionHeightSize_m=PhysicalParameters.OG_REAL_HEIGHT, perceptionWidthSize_m=PhysicalParameters.OG_REAL_WIDTH)
        planner = HybridAStar(conv, max_exec_time_ms=TestLPHybridA.TIMEOUT_MS)
