...
TEST(TestGraphBestNode, TestGoalReached)
{
    ...
    ASSERT_FALSE(g.checkGoalReached(ptr, {128, 0}, angle::deg(10), 5.0, 1));

    g.add(128, 128, angle::deg(0), -1, -1, 0);
    g.add(128, 3, angle::deg(10), 128, 128, 10);

    ASSERT_TRUE(g.checkGoalReached(ptr, {128, 0}, angle::deg(10), 5.0, 1));
...
TEST(TestGraphBestNode, TestBestNode)
{
    ...
    int2 p = g.findBestNode(ptr, angle::deg(0), 50.0, 128, 0, 1);
